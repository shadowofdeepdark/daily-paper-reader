...
tags: ["query:q7"]
score: 8.0
evidence: 利用认知语言学理论研究多种语言中的成语和比喻意义
tldr: 提出了一个跨八种语言的成语和比喻意义表示网络框架，发现成语按概念图式聚类。
source: arxiv
selection_source: fresh_fetch
figures_json: "[{\"url\": \"assets/figures/arxiv/2607.09576v1/fig-001.webp\", \"caption\": \"Figure 1: Feature annotation schema. An idiom is decomposed into three conceptual dimensions.\", \"page\": 4, \"index\": 1, \"width\": 473, \"height\": 436}]"
motivation: 利用认知语言学理论研究多种语言中的成语和比喻意义。
